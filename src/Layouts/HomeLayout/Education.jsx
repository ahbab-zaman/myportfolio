...
const Education = () => {
  return (
    <div className="w-11/12 mx-auto">
      ...
      <div className="py-8 flex lg:flex-row flex-col justify-between items-center gap-3">
        <div
          className="bg-[#2B384C] text-white py-5 lg:px-8 px-[70px] space-y-2
                "
        >
          <h4 className="text-gray-500 text-center">-BBA-</h4>
          <h1 className="text-xl font-bold">Modon Mohon College</h1>
        ...
        >
          ...
          <h1 className="text-xl font-bold">Blue Bird High School & College</h1>
