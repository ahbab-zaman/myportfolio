          ...
          <div className="relative ">
            ...
            <div className="absolute w-3/4 mx-auto left-14 rounded-xl -bottom-4 bg-[#F0F1F3] p-3 flex justify-around items-center shadow-xl">
              <Link to="https://www.facebook.com/profile.php?id=100015172482884&mibextid=ZbWKwL">
                <img className="w-8 hover:border hover:border-black hover:rounded-full hover:p-1 hover:transition-all hover:duration-300" src={facebook} alt="" />
              </Link>
              <Link to="https://github.com/ahbab-zaman">
                {" "}
                <img className="w-8 hover:border hover:border-black hover:rounded-full hover:p-1 hover:transition-all hover:duration-300" src={github} alt="" />
              </Link>
            </div>
          </div>
          <div>
